...
--Query that returns total quantity of all products with id of p4 sold in the year 2020 to 2022
...
-- information on all their clients and the orders that they placed in the years 2022 and 2021
...
--query to analyse sales performance of product p3 using a function that takes parameters: productid and year
